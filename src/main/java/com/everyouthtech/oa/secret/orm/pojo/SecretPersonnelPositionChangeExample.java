...
public class SecretPersonnelPositionChangeExample {
    /**
    ...
    public SecretPersonnelPositionChangeExample() {
    ...
    /**
     * This class corresponds to the database table t_secret_personnel_position_change
     *
