...
public class SecretPersonnelRelatedProjectExample {
    /**
    ...
    public SecretPersonnelRelatedProjectExample() {
    ...
    /**
     * This class corresponds to the database table t_secret_personnel_related_project
     *
